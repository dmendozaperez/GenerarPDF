		...
		<html>
			...
			<body>
				...
				<xsl:variable name="Campo12_TasaPercepcion">
					<xsl:value-of select="format-number(//sac:SUNATPerceptionPercent ,'#,##0.00', 'euro')"/>
				</xsl:variable>		
				...
				<xsl:variable name="Campo14_ImpuestoCobrado">
					<xsl:if test="//sac:SUNATTotalCashed != ''">
						<xsl:value-of select="format-number(//sac:SUNATTotalCashed ,'#,##0.00', 'euro')"/>
					</xsl:if>
				</xsl:variable>	
				<xsl:variable name="Campo28_MontoLetras">
					<xsl:value-of select="//ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/sac:AdditionalInformation/sac:AdditionalProperty[cbc:ID='P040']/cbc:Value"/>
				</xsl:variable>				
						...
						<table id="itemsDetail">
							<tr id="trtitulo" class="BorSolid">
								...
								<td class="BorArr BorDer Titulo_Detalle" width="478px">
									Importe neto cobrado<br/>incluida la percepción<br/>(S/)
								</td>
								<td class="BorArr BorDer Titulo_Detalle" width="340px">
									Valor aplicado
								</td>
								...
								<tr>
									...
									<td style="text-align:center" class="BorDer fuente8 BorAba col10">
										<xsl:if test="sac:SUNATPerceptionInformation/sac:SUNATPerceptionAmount != ''">
											<xsl:value-of select="format-number(sac:SUNATPerceptionInformation/sac:SUNATPerceptionAmount ,'#,##0.00', 'euro')"/>
										</xsl:if>
									</td>
									<td style="text-align:center" class="BorDer fuente8 BorAba col11">
										<xsl:if test="sac:SUNATPerceptionInformation/sac:SUNATNetTotalCashed != ''">
											<xsl:value-of select="format-number(sac:SUNATPerceptionInformation/sac:SUNATNetTotalCashed ,'#,##0.00', 'euro')"/>
										</xsl:if>
									</td>
									<td style="text-align:center" class="BorDer fuente8 BorAba col2">
										<xsl:if test="sac:SUNATPerceptionInformation/cac:ExchangeRate/cbc:CalculationRate != ''">
											<xsl:value-of select="format-number(sac:SUNATPerceptionInformation/cac:ExchangeRate/cbc:CalculationRate ,'#,##0.000000', 'euro')"/>
										</xsl:if>
									</td>
