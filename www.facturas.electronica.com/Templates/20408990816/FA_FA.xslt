  ...
  <xsl:template match="r:Invoice">
    <html>
      ...
      <body>
        ...
        <xsl:variable name="Campo38_OperacionGratuita">
                  ...
                  <td style="text-align:center" class="BorDer BorAba fuente8 col7 ItemDetalle">
                    ...
                    <xsl:choose>
                      <xsl:when test="$Temp = 2">
                        <!--<xsl:value-of select="format-number(cac:PricingReference/cac:AlternativeConditionPrice[cbc:PriceTypeCode=02]/cbc:PriceAmount,'#,##0.000','euro')"/>-->
                        <xsl:choose>
                      ...
                      <xsl:otherwise>
                        <!--<xsl:value-of select="format-number(cac:PricingReference/cac:AlternativeConditionPrice/cbc:PriceAmount,'#,##0.000','euro')"/>-->
                        <xsl:choose>
                      ...
                      <td>
                        <table>
                          <tr>
                            ...
                            <td style="word-wrap:break-word;text-align:right;vertical-align:top" class="fuente8">
                              <xsl:value-of select="$Campo38_OperacionGratuita" />
                              <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;]]></xsl:text>
                            </td>
                          </tr>
                          <tr>
